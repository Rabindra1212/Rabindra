...
Class ListNews extends \Magento\Framework\View\Element\Template
{
	...
	public function __construct(
		...
		\Rabindra\News\Model\AllnewsFactory $allNewsFactory
	){
	...
	protected function _prepareLayout(){
		...
		if ($this->getListNews()){
			$pager = $this->getLayout()->createBlock('Magento\Theme\Block\Html\Pager', 'rabindra.news.pager')
